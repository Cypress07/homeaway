...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.sQ9dDwD' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_SQ9dDwDService()
    {
        return $this->privates['.service_locator.sQ9dDwD'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
        ...
        return [
            ...
            'vich_uploader.mappings' => [
                'property_image' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/media/properties'),
                    'namer' => [
