...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getAdminOptionControllerService()
    {
        ...
        $this->services['App\\Controller\\Admin\\AdminOptionController'] = $instance = new \App\Controller\Admin\AdminOptionController(($this->privates['App\\Repository\\OptionRepository'] ?? $this->getOptionRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
